...
function bridge(overrides: Partial<PianoBridge> = {}): PianoBridge {
  return {
    ...
    correctInLibrary: () => Promise.reject(new Error('not used')),
    removeFromLibrary: () => Promise.reject(new Error('not used')),
    libraryLeftBehind: () => Promise.resolve([]),
    onLibraryChanged: () => () => {},
    ...
    readHistory: () => Promise.reject(new Error('not used')),
    writeHistory: () => Promise.reject(new Error('not used')),
    saveHistory: () => Promise.reject(new Error('not used')),
    clearHistory: () => Promise.reject(new Error('not used')),
