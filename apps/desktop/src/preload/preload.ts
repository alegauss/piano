...
const bridge: PianoBridge = {
  ...
  correctInLibrary: async (request) => invoke(CHANNEL_NAMES.libraryCorrect, request),
  removeFromLibrary: async (request) => invoke(CHANNEL_NAMES.libraryRemove, request),
  libraryLeftBehind: async () => invoke(CHANNEL_NAMES.libraryLeft, null),
  ...
  readHistory: async () => invoke(CHANNEL_NAMES.historyRead, null),
  writeHistory: async (request) => invoke(CHANNEL_NAMES.historyWrite, request),
  saveHistory: async () => invoke(CHANNEL_NAMES.historySave, null),
  clearHistory: async () => invoke(CHANNEL_NAMES.historyClear, null),
